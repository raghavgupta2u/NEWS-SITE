...
<?php   
  ...
  $u_role = mysqli_real_escape_string($con,$_POST['u_role']);
  
  $sql = "UPDATE user SET first_name ='{$fname}', last_name='{$lname}', username = '{$user}', role = '{$u_role}' WHERE user_id = {$id}";
              ...
              <div class="col-md-offset-4 col-md-4">
                  ...
                  <form  action="<?php $_SERVER['PHP_SELF'];?>" method ="post">
                      ...
                      <div class="form-group">
                          ...
                          <select class="form-control" name="u_role" value="<?php echo $row['role'] ?>">
                            <?php
                            if($row['role']==1){
